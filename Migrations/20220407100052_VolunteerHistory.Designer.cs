...
namespace Karma.Migrations
{
    ...
    [Migration("20220407100052_VolunteerHistory")]
    partial class VolunteerHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Karma.Models.CharityEventVolunteers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid?>("CharityEventId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CharityEventVolunteers");
                });
            ...
            modelBuilder.Entity("Karma.Models.CharityEventVolunteers", b =>
                {
                    b.HasOne("Karma.Models.CharityEvent", "CharityEvent")
                        .WithMany()
                        .HasForeignKey("CharityEventId");

                    b.HasOne("Karma.Models.Volunteer", "Volunteer")
                        .WithMany()
